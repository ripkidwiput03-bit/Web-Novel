...
() {
  ...
  typeset -g __p9k_instant_prompt_param_sig=$'1.20.15\C-A5.9\C-Azsh-5.9-0-g73d3173\C-A\C-A\'\'\C-A52\C-Au0_a303%\C-A\C-A\C-A\C-A\C-A\C-A\C-A1\C-A0\C-A0\C-A\C-A%B%S%#%s%b\C-A0\C-AUTF-8\C-A\C-A\C-A0\C-A1\C-A/data/data/com.termux/files/home/.oh-my-zsh/custom/themes/powerlevel10k\C-A\C-A\C-A\C-A\C-A1\C-A256\C-A0\C-Amagenta\C-Agreen\C-Agreen\C-Ayellow\C-Ared\C-A20\C-Ayellow\C-A3\C-A39\C-Acyan\C-Ayellow\C-A31\C-Acyan\C-Acyan\C-A103\C-Atrue\C-Amoderate\C-Averbose\C-Aos_icon\C-Bdir\C-Bvcs\C-Bprompt_char\C-Anerdfont-complete\C-A%F{014}╭─\C-A%F{014}╰─%F{cyan}❯%F{magenta}❯%F{green}❯ %f\C-A🐧\C-Acyan\C-Atrue\C-A⚡\C-A196\C-A⚡\C-A196\C-A196\C-A196\C-A⚡\C-A76\C-A⚡\C-A76\C-A76\C-A76\C-Atrue\C-Agreen\C-Astatus\C-Bcommand_execution_time\C-Bbackground_jobs\C-Bram\C-Btime\C-Bbattery\C-A3\C-Atruncate_to_last\C-Ared\C-Afalse\C-A66\C-A%D{%H:%M}\C-A⏰\C-Aoff\C-A \C-A76\C-A178\C-Ayellow'
  local gitstatus_dir=/data/data/com.termux/files/home/.oh-my-zsh/custom/themes/powerlevel10k/gitstatus
  ...
  local cr=$'\r' lf=$'\n' esc=$'\e[' rs=$'\x1e' us=$'\x1f'
  local -i height=1
  local prompt_dir=/data/data/com.termux/files/home/.cache/p10k-u0_a303
  ...
  local -A _p9k_display_k=(1/right/battery 35 -2/left 11 1/left/prompt_char 23 -2/right/ram 31 2/left 43 1/right/background_jobs 29 -2/left/prompt_char 23 -1/right 45 -1/left/_p9k_internal_nothing 49 1/left/dir 19 -1/left 43 -2/left/vcs 21 1/right_frame 9 1/right 13 2/right 45 -2/right 13 -2/right/background_jobs 29 2/right_frame 41 -2/right_frame 9 2/left/_p9k_internal_nothing 49 empty_line 1 -1 37 -2 5 1/left 11 -1/gap 47 -1/right_frame 41 -2/gap 15 1/left/vcs 21 1/right/time 33 -2/right/status 25 1 5 1/left_frame 7 ruler 3 2 37 -1/left_frame 39 -2/left/os_icon 17 -2/right/battery 35 -2/right/time 33 1/gap 15 2/gap 47 1/right/command_execution_time 27 2/left_frame 39 -2/left_frame 7 -2/right/command_execution_time 27 1/right/status 25 -2/left/dir 19 1/left/os_icon 17 1/right/ram 31)
  local -a _p9k__display_v=(empty_line hide ruler hide 1 show 1/left_frame show 1/right_frame show 1/left show 1/right show 1/gap show 1/left/os_icon show 1/left/dir show 1/left/vcs show 1/left/prompt_char show 1/right/status show 1/right/command_execution_time show 1/right/background_jobs show 1/right/ram show 1/right/time show 1/right/battery show 2 show 2/left_frame show 2/right_frame show 2/left show 2/right show 2/gap show 2/left/_p9k_internal_nothing show)
  function p10k() {
    emulate -L zsh -o no_hist_expand -o extended_glob -o no_prompt_bang -o prompt_percent -o no_prompt_subst -o no_aliases -o no_bg_nice -o typeset_silent -o no_rematch_pcre
  (( $+__p9k_trapped )) || { local -i __p9k_trapped; trap : INT; trap "trap ${(q)__p9k_trapint:--} INT" EXIT }
  local -a match reply mbegin mend
